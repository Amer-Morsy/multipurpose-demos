        ...
        <div class="row justify-content-between">
            <div class="col-lg-4 col-sm-12 pt40">
                <div class="footerdez-a">
                    ...
                    <p class="mt10">Feel free to reach out if you want to collaborate with us, or simply have a
                        call.</p>
                    ...
                    <div class="col-lg-6 pt60">
                        <div class="footer-copyrights-">
                            <p>© 2020-2022. All Rights Reserved By <a
                                    href="#" target="blank">Amer Morsy</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contactinfo-bar mt50">
            ...
            <div class="contact-data">
                <ul class="mt10">
                    ...
                    <li><a href="mailto:info@businessname.com"><i class="fas fa-envelope"></i> info@businessname.com</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="contact-data">
                <ul class="mt10">
                    <li><a href="#"><i class="fas fa-map-marker-alt"></i>
                            <div class="locoff"><span>India</span>9988 Piazzetta Scalette Rubiani 99, Rome, 84090</div>
                        </a></li>
                    <li><a href="#"><i class="fas fa-map-marker-alt"></i>
                            <div class="locoff"><span>USA</span>9988 Piazzetta Scalette Rubiani 99, Rome, 84090</div>
                        </a></li>
                </ul>
            </div>
        </div>
