        ...
        <div class="menu-header">
            ...
            <div class="custom-nav" role="navigation">
                <ul class="nav-list onepge">
                            ...
                            <div class="sub-menu-section">
                                <div class="sub-menu-center-block">
                                    <div class="sub-menu-column smfull">
                                        <ul>
                                            <li><a href="{{route('landing-page')}}">Landing Page 1</a></li>
                                            <li><a href="{{route('landing-page.second-version')}}">Landing Page 2</a>
                                            </li>
                    ...
                    <li><a data-bs-toggle="offcanvas" href="#offcanvasExample" class="btn-round- btn-br bg-btn3"><i
                                class="fas fa-qrcode"></i></a></li>
        ...
        <nav id="main-nav">
            <ul class="first-nav">
                <li>
                    ...
                    <ul>
                        <li><a href="{{route('landing-page')}}">Landing Page 1</a></li>
                        <li><a href="{{route('landing-page.second-version')}}">Landing Page 2</a></li>
                    </ul>
                </li>
                <li><a href="#home" class="menu-links">Home</a></li>
                <li><a href="#services" class="menu-links">Services</a></li>
