...
@section('content')
    @include('includes.digital-marketing.header')
    <main>
        <!--Start Hero-->
                    ...
                    <div class="row">
                        <div class="col-lg-6 v-center">
                            <div class="header-heading">
                                <h1 class="wow fadeInUp" data-wow-delay=".2s"><span
                                        class="xhighlight">Result Based</span> Digital Marketing</h1>
                                <p class="wow fadeInUp" data-wow-delay=".4s">Lorem ipsum dolor sit amet, consectetur
                                    ...
                                    tempor eros.</p>
                                <a href="#contact" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s">Get A
                                    Free Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                            </div>
                        </div>
                        <div class="col-lg-6 v-center">
                ...
                <div class="row">
                    <div class="col-lg-6 v-center">
                        <div class="image-block">
                            <img src="images/about/about-service.png" alt="about" class="img-fluid no-shadow"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="common-heading text-l">
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                ...
                                dummy text of the printing and typesetting industry. is simply dummy text of the
                                printing and typesetting industry. </p>
                            <a href="#contact" class="btn-main bg-btn lnk mt30">Contact Us <i
    ...
    @include('includes.digital-marketing.footer')
@endsection
