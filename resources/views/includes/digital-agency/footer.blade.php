        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-3 col-sm-6  ftr-brand-pp">
                    <a class="navbar-brand mt30 mb25" href="#"> <img src="images/white-logo.png" alt="Logo"
                                                                     width="100"/></a>
                    ...
                    <div class="single-blog-">
                        ...
                        <div class="content">
                            <p class="post-meta"><span class="post-date"><i
                                        class="far fa-clock"></i>April 15, 2020</span></p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="footer-">
                            <p>© 2020-2022. All Rights Reserved By <a href="#" target="blank">Amer Morsy</a></p>
                        </div>
                    </div>
                </div>
            </div>
