...
@section('main')
    <main>
        ...
        <section class="hero-section niwax-lp2" id="home">
            <div class="niwax-lp-img nlp2 niwax" data-rellax-speed="-2"><img
                    src="{{asset('images/hero/niwax-lp-2b.svg')}}" alt="">
            </div>
            <div class="niwax-lp-img nlp1 niwax" data-rellax-speed="4"><img
                    src="{{asset('images/hero/niwax-lp-2a.svg')}}" alt="">
            </div>
            <div class="niwax-lp-img nlp4 niwax" data-rellax-speed="2"><img
                    src="{{asset('images/hero/niwax-lp-2d.svg')}}" alt="">
            </div>
            <div class="niwax-lp-img nlp3 niwax" data-rellax-speed="3"><img
                    src="{{asset('images/hero/niwax-lp-2c.svg')}}" alt="">
            </div>
                    ...
                    <div class="row v-center">
                        <div class="col-lg-7">
                            <div class="header-headings">
                                ...
                                <h1 class="wow fadeIn mt20 mb30" data-wow-delay=".4s">The most straightforward payment
                                    solution for your company's requirements</h1>
                        ...
                        <div class="col-lg-5 v-center">
                            <div class="niwax-lpimg-2">
                                <img src="{{asset('images/hero/payment.svg')}}" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="dg-service2 pad-tb" id="services">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-sm-6 mt30 wow fadeIn niwax" data-wow-delay=".2s" data-rellax-speed=".5"
                         data-rellax-percentage=".5">
                        <div class="s-block text-l hoverwithbg up-hor animation">
                            <div class="nx-circl-icon nxlp-a"><img src="{{asset('images/icons/integration.png')}}"
                                                                   alt="icon"></div>
                    ...
                    <div class="col-lg-3 col-sm-6 mt30 wow fadeIn niwax" data-wow-delay=".2s" data-rellax-speed="-.5"
                         data-rellax-percentage=".5">
                        <div class="s-block text-l hoverwithbg up-hor animation">
                            <div class="nx-circl-icon nxlp-b"><img src="{{asset('images/icons/integration.png')}}"
                                                                   alt="icon"></div>
                    ...
                    <div class="col-lg-3 col-sm-6 mt30 wow fadeIn niwax" data-wow-delay=".2s" data-rellax-speed=".5"
                         data-rellax-percentage=".5">
                        <div class="s-block text-l hoverwithbg up-hor animation">
                            <div class="nx-circl-icon nxlp-c"><img src="{{asset('images/icons/integration.png')}}"
                                                                   alt="icon"></div>
                    ...
                    <div class="col-lg-3 col-sm-6 mt30 wow fadeIn niwax" data-wow-delay=".2s" data-rellax-speed="-.5"
                         data-rellax-percentage=".5">
                        <div class="s-block text-l hoverwithbg up-hor animation">
                            <div class="nx-circl-icon nxlp-d"><img src="{{asset('images/icons/integration.png')}}"
                                                                   alt="icon"></div>
                    ...
                    <div class="companyawards col-lg-9">
                        <div class="niwax-logo-awards niwax-logo-slider owl-carousel">
                            ...
                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/house.svg')}}" alt="img">
                                <h6>Real estate</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/travel-case.svg')}}" alt="img">
                                <h6>Tour &amp; Travels</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/video-tutorials.svg')}}" alt="img">
                                <h6>Education</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/taxi.svg')}}" alt="img">
                                <h6>Transport</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/event.svg')}}" alt="img">
                                <h6>Event</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/smartphone.svg')}}" alt="img">
                                <h6>eCommerce</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/joystick.svg')}}" alt="img">
                                <h6>Game</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/healthcare.svg')}}" alt="img">
                                <h6>Healthcare</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/money-growth.svg')}}" alt="img">
                                <h6>Finance</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/baker.svg')}}" alt="img">
                                <h6>Restaurant</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/mobile-app.svg')}}" alt="img">
                                <h6>On-Demand</h6>
                            </div>

                            <div class="industry-workfors">
                                <img src="{{asset('images/icons/groceries.svg')}}" alt="img">
                                <h6>Grocery</h6>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="img-design h-scl-">
                            <div class="imgac "><img src="{{asset('images/hero/creative-ag2a.jpg')}}"
                                alt="creative agnecy html template"
                                class="ag-dg1 img-fluid h-scl-base">
                            </div>
                            <div class="imgac h-scl-base"><img src="{{asset('images/hero/creative-ag2b.jpg')}}"
                                alt="creative agnecy html template"
                                class="ag-dg2 img-fluid ">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="niwaxwideserviceslider owl-carousel center-dots">
                            ...
                            <div class="sliderset-nx">
                                <div class="service-we-deliverd">
                                    ...
                                    <p class="mt20">We have been providing Digital Marketing service from last 8 years
                                        by direct collaboration with our clients. As a Digital Marketing company we are
                                ...
                                <div class="imagesofservice">
                                    <img src{{asset('images/service/payment-service-1.svg')}}" alt="niwax landing page
                                    2"
                                    class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="sliderset-nx">
                                ...
                                <div class="imagesofservice">
                                    <img src{{asset('images/service/payment-service-2.svg')}}" alt="niwax landing page
                                    2"
                                    class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="sliderset-nx">
                                ...
                                <div class="imagesofservice">
                                    <img src{{asset('images/service/payment-service-3.svg')}}" alt="niwax landing page
                                    2"
                                    class="img-fluid">
                                </div>
                            </div>
                            ...
                            <div class="sliderset-nx">
                                ...
                                <div class="imagesofservice">
                                    <img src{{asset('images/service/payment-service-4.svg')}}" alt="niwax landing page
                                    2"
                                    class="img-fluid">
                                </div>
                            </div>
                        ...
                        <div class="whychooseniwax v-center">
                            ...
                            <div class="niwaxawardrow1">
                                <div class="awardbgwithtext">
                                    <img src{{asset('images/icons/award-bg.png')}}" alt="">
                        ...
                        <div class="niwax-review-slider owl-carousel center-dots">
                            <div class="reviews-card pr-shadow">
                                <div class="row v-center">
                                    ...
                                    <div class="col"><span class="revbx-rl"><img src{{asset('images/client/upwork-logo.png')}}"
                                ...
                                <div class="-client-details-">
                                    <div class="-reviewr">
                                        <img src="{{asset('images/client/reviewer-a.jpg')}}" alt="Good Review"
                                             class="img-fluid">
                                    </div>
                            ...
                            <div class="reviews-card pr-shadow">
                                <div class="row v-center">
                                    ...
                                    <div class="col"><span class="revbx-rl"><img
                                                src="{{asset('images/client/upwork-logo.png')}}"
                                                alt="review service logo"></span></div>
                                </div>
                                <div class="review-text">
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                        <div class="s-block wide-sblock">
                            <div class="s-card-icon"><img src{{asset('images/icons/teama.svg')}}" alt="service"
                                class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                        <div class="s-block wide-sblock">
                            <div class="s-card-icon"><img src{{asset('images/icons/link.svg')}}" alt="service"
                                class="img-fluid">
                            </div>
                            <div class="s-block-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                        <div class="s-block wide-sblock">
                            <div class="s-card-icon"><img src{{asset('images/icons/tech.svg')}}" alt="service"
                                class="img-fluid">
                            </div>
                            <div class="s-block-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
                        <div class="s-block wide-sblock">
                            <div class="s-card-icon"><img src{{asset('images/icons/hi.svg')}}" alt="service"
                                class="img-fluid">
                            </div>
                            <div class="s-block-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
                        <div class="s-block wide-sblock">
                            <div class="s-card-icon"><img src{{asset('images/icons/badge.svg')}}" alt="service"
                                class="img-fluid">
                            </div>
                            <div class="s-block-content">
                    ...
                    <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
                        <div class="s-block wide-sblock">
                            <div class="s-card-icon"><img src{{asset('images/icons/tin.svg')}}" alt="service"
                                class="img-fluid">
                            </div>
                            <div class="s-block-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="niwax-client-slider owl-carousel">
                            <div class="awardlogo"><img src="{{asset('images/client/customer-logo-1.png')}}" alt="icon">
                            </div>
                            <div class="awardlogo"><img src="{{asset('images/client/customer-logo-2.png')}}" alt="icon">
                            </div>
                            <div class="awardlogo"><img src="{{asset('images/client/customer-logo-3.png')}}" alt="icon">
                            </div>
                            <div class="awardlogo"><img src="{{asset('images/client/customer-logo-4.png')}}" alt="icon">
                            </div>
                            <div class="awardlogo"><img src="{{asset('images/client/customer-logo-5.png')}}" alt="icon">
                            </div>
                        </div>
                    </div>
                </div>
