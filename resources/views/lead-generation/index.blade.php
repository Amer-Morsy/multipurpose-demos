...
@section('content')
    @include('includes.lead-generation.header')
    <main>
        <!--Start Hero-->
        <section class="hero-section lead-hero" id="home">
                        ...
                        <div class="col-lg-6 v-center">
                            <div class="header-heading">
                                ...
                                <a href="#" class="btn-main bg-btn lnk wow fadeInUp" data-wow-delay=".6s"
                                   data-bs-toggle="modal" data-bs-target="#menu-popup">Get Strategy Call <i
                                        class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                            </div>
                        </div>
                        <div class="col-lg-6 wow fadeIn" data-wow-delay=".4s">
                            <div class="single-image"><img src="images/hero/leads-hero.png" alt="hero image"
                                                           class="img-fluid"/></div>
                        </div>
                    </div>
                </div>
        ...
        <!--End statistics-->
        <!--Start About-->
        <section class="about-lead-gen pad-tb" id="about">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="common-heading text-l">
                            ...
                            <p class="mt10">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an
                                unknown printer took a galley of type and scrambled it to
                                make a type specimen book.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 lead-intro-"><img src="images/about/lead-about.png" alt="image"
                                                           class="img-fluid"/></div>
                </div>
            </div>
        </section>
        <!--End About-->
        <!--Start Service-->
        <section class="bhv-service bg-gradient5 pad-tb" id="services">
            <div class="container">
                ...
                <div class="-cta-btn mt70">
                    <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1s">
                        ...
                        <a href="#" class="btn-main bg-btn2 lnk"> Free Quote<i class="fas fa-chevron-right fa-icon"></i><span
                                class="circle"></span></a>
                    </div>
                </div>
            </div>
        ...
        <!--End Service-->
        <!--Start why choose us-->
        <section class="why-choos-lg pad-tb" id="whywe">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="common-heading text-l">
                    ...
                    <div class="col-lg-6">
                        <div class="single-image"><img src="images/about/marketing-service.png" alt="hero image"
                                                       class="img-fluid"/></div>
        ...
        <!--End why choose us-->
        <!--Start Clients-->
        <section class="clients-section lead-gen-client pad-tb" id="clients">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="common-heading">
                        ...
                        <div class="opl">
                            <ul>
                                ...
                                <li class=" wow fadeIn" data-wow-delay="1.2s">
                                    <div class="clients-logo"><img src="images/client/clients-7.png" alt="text"
                                                                   class="img-fluid"/></div>
                                </li>
                                <li class=" wow fadeIn" data-wow-delay="1.4s">
                                    <div class="clients-logo"><img src="images/client/clients-8.png" alt="text"
                                                                   class="img-fluid"/></div>
                                </li>
                                <li class=" wow fadeIn" data-wow-delay="1.6s">
                                    <div class="clients-logo"><img src="images/client/clients-9.png" alt="text"
                                                                   class="img-fluid"/></div>
                                </li>
                                <li class=" wow fadeIn" data-wow-delay="1.8s">
                                    <div class="clients-logo"><img src="images/client/clients-10.png" alt="text"
                                                                   class="img-fluid"/></div>
                                </li>
                                <li class=" wow fadeIn" data-wow-delay="2s">
                                    <div class="clients-logo"><img src="images/client/clients-11.png" alt="text"
                                                                   class="img-fluid"/></div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 v-center">
                        <div class="enquire-image">
                            <img src="images/about/lead-pic.png" alt="enquire" class="img-fluid"/>
                        </div>
                    </div>
                </div>
            </div>
...
<a href="#"><i class="fas fa-clock"></i> Sep 24, 2019</a>
    ...
    @include('includes.lead-generation.footer')
@endsection
