...
@section('title', 'Web Design Agency')
@section('content')
    @include('includes.web-design-agency.header')
    <main>
        <!--Start Hero-->
                    ...
                    <div class="row">
                        <div class="col-lg-6 v-center">
                            <div class="header-heading">
                                <h1 class="wow fadeInUp" data-wow-delay=".2s">Creative Web Development Company</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="common-heading text-l">
                            ...
                            <div class="user- mt30">
                                <div class="media">
                                    <div class="user-image bdr-radius"><img src="images/user-thumb/girl2.jpg" alt="girl"
                                                                            class="img-fluid"/></div>
    ...
    @include('includes.web-design-agency.footer')
@endsection
